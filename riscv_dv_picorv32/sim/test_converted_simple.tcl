# Test with converted hex file
create_project -force conv_test ./conv_sim -part xc7a100tcsg324-1
set_property target_language Verilog [current_project]

# Add RTL
add_files -norecurse ../../picorv32/picorv32.v

# Create and add simple testbench
...
set fh [open "conv_test_tb.sv" w]
puts $fh $testbench_content
close $fh

# Add testbench
add_files -norecurse conv_test_tb.sv

# Set top
set_property top conv_test [current_fileset]
